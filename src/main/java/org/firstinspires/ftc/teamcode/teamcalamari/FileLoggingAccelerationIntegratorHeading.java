...
public class FileLoggingAccelerationIntegratorHeading implements BNO055IMU.AccelerationIntegrator {
    ...
    //the constructor
    public FileLoggingAccelerationIntegratorHeading(DataLogger logger) {
		this.logger = logger;
	...
	public FileLoggingAccelerationIntegratorHeading clone(int i) {
		FileLoggingAccelerationIntegratorHeading integrator = new FileLoggingAccelerationIntegratorHeading(new DataLogger(this.logger.fileName+" "+i));
