...
/**DEPRECATED - Use {@link AutonomousRobotNavigation}instead*/
@Deprecated
public class AutonomousNavigation {
	...
	public AutonomousNavigation(int targetNumber, double dSpeed, double dDriveSpeed, double dStatTurnSpeed, double dStatTurnTurnSpeed, OpMode opMode) {
	...
	public static <T> ArrayList<T> setDefaultArrayListValue(T defaultValue, int targetNum) {
		ArrayList<T> list = new ArrayList<>(Math.max(targetNum, 0));
	...
	protected void runStationaryTurn() {
