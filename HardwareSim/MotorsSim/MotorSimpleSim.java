...
public class MotorSimpleSim implements HardwareDeviceSim, DcMotorSimple {
    protected GamepadSim gamepad;
    ...
    public <T extends MotorSimpleSim> MotorSimpleSim(String motorName, HardwareMapSim hwMap, Class<T> clazz){
