...
public class SwifferMotorSim extends MotorSimpleSim {
	...
	public SwifferMotorSim(MotorSimpleSim motor) {
		super(motor);
	}
	public SwifferMotorSim(MotorSimpleSim motor, Direction inDirection) {
		this(motor);
		this.inDirection = inDirection;
	}
	public SwifferMotorSim(String motorName, HardwareMapSim hwMap, Class<? extends MotorSimpleSim> clazz, Direction inDirection) {
	...
	public void runIn(double power) {
		...
		resetPower(inDirection == Direction.FORWARD ? power : -power);
	}
	/**Run the motor so as to pull things in*/
	public void runIn() {
		this.runIn(1);
    ...
    public void run(GamepadJoystick joystick, double scale){
	    ...
	    resetPower(inDirection == Direction.FORWARD ? val : -val);
    }
