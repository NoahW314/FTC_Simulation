...
public class CompareAutoVuforiaObs extends LinearOpModeSim {
	...
	public void runOpMode() throws InterruptedException {
	    ...
	    nav.drivingTurns.set(0, new Angle(135, AngleUnit.DEGREES, AxesSet.FIELD_AXES));
        ...
        while(opModeIsActive()) {
    	    ...
    	    nav.drivingTurns.set(0, new Angle(Math.atan2(targetPose.get(1)-nav.getPosition().get(1), 
