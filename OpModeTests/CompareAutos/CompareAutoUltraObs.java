...
public class CompareAutoUltraObs extends LinearOpModeSim {
	...
	public void runOpMode() throws InterruptedException {
        ...
        double[] maxUltraX = new double[] {24, 48};
        double[] maxUltraY = new double[] {72, 48};
        ...
        while(opModeIsActive()) {
        	if(nav.robotAction == RobotActions.DRIVING) {
	        	if(nav.i > 0 && nav.i < 2) {
	        		...
	        		ultraX.distance = maxUltraX[1]-ultraXToRobotCenter;
	        		ultraY.distance = maxUltraY[1]-ultraYToRobotCenter;
	        	}
        	}
        	else {
        		totalTime.reset();
