...
public class AutoCompDepot extends LinearOpModeSim {

    private RoverRobotSim robot = new RoverRobotSim(RoverRobotSim.RoverCompPrograms.DEPOT);
    ...
    public void runOpMode(){
        ...
        nav.actions.set(2, robot.placeTeamMarker);
